...
- The source code includes Google OAuth client credentials (Client ID and Client Secret)
...
**Why is the client secret in the code?**
- This is standard practice for public client applications (browser extensions, mobile apps, desktop apps)
- The secret doesn't grant access to user data - users must explicitly authorize the app
